...
final class CPYUtilities {
    ...
    static func registerUserDefaultKeys() {
        ...
        defaultValues.updateValue(NSNumber(value: 20), forKey: Constants.UserDefaults.thumbnailWidth)
        defaultValues.updateValue(NSNumber(value: 20), forKey: Constants.UserDefaults.thumbnailHeight)
